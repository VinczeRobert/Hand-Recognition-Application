...
class TrainNeuralNetworkController:
    def __init__(self):
        ...
        self.train_neural_network_view = self.main_view.train_neural_network_view

        self.train_neural_network_view.load_h5_button.clicked.connect(lambda: self.set_h5_file())
    ...
    def set_h5_file(self):
        self.h5_file = self.train_neural_network_view.choose_h5_file()
    ...
    def train_network(self):
        ...
        self.training_data_reader.split_data()

        if self.settings.h5_path is not None:
            self.training_data_reader.save_to_h5('D:/Hand-Recognition-Application/data/h5/new_shit.h5')

        self.cnn_architecture.train_model(self.training_data_reader.training_data, self.training_data_reader.training_class_labels)
