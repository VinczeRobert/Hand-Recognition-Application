...
class ImagePreprocessor:
    def __init__(self, hand_index, var_threshold):
    ...
    def prepare_image_for_classification(self, image, is_binary, with_cropping):
        ...
        binary_image = background_subtractor.apply(filtered_image, learningRate=0)
    ...
    def set_background_subtractor(self):
        ...
        background_subtractor = cv.createBackgroundSubtractorMOG2(0, self.var_threshold, detectShadows=False)
